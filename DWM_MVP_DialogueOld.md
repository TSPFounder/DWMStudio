...
## Hillside — Sophia Sandoval (sawmill foreman, Small Town Stores)
...
## Valley — Maria Vega (grain co-op lead)
...
1. **Named NPCs for Hillside, Valley, Suburb, and City are new
   inventions** (Sophia Sandoval, Maria Vega, DeShawn Okafor, Itzel Reyes,
...
5. **Sophia's sawmill line assumes QuadArt's Survivor Base is the source**
